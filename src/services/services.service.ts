  ...
  typesOfServices: IService[] = [
    {
      ...
      value: 39.99,
      description:
        'Our password reset services can help you get back into your machines.',
    ...
    },
    {
      ...
      value: 99.99,
      description:
        'Is your computer running slow? You might need our spyware removal service.',
    ...
    },
    {
      ...
      value: 45.0,
      description:
        "If your keys get stuck or your keyboard has debris in between the keys, it's time for a clean.",
    ...
    },
    {
      ...
      value: 149.99,
      description:
        'Large/leftoverall installation files clogging your space? We can assist in cleaning things up.',
    ...
    },
    {
      ...
      value: 149.99,
      description:
        'Computer running sluggishly? Not enough disk space? It might be time for a tuneUp.',
